# Contributing to UX Blocks

> **Read-only mirror.** This repository (`symfinity/ux-blocks`) is published from the Symfinity product monorepo (`packages/ux-blocks/`). **Do not expect pull requests to be merged here.**

## Report bugs or request features

Open an [issue](https://github.com/symfinity/ux-blocks/issues) on this repository.
...
Open a pull request on the **product monorepo** (`packages/ux-blocks/`) on a `feature/{spec-id}-{slug}` branch. Do not rely on merging on this mirror.
